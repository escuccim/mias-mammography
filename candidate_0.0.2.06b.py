...
# 0.0.2.06 - removed fc3, it wasn't necessary
...
with graph.as_default():
    ...
    # Layer 2
    conv2_res = _conv2d_batch_norm(pool1, 64, kernel_size=(3, 3), stride=(1, 1), training=training, epsilon=1e-8, padding="SAME", seed=None, lambd=lamC, name="2.0", activation=None)

    conv2 = tf.nn.relu(conv2_res, name='relu_2.0.1')
    ...
    conv3_res = _conv2d_batch_norm(pool2, 96, kernel_size=(3, 3), stride=(1, 1), training=training, epsilon=1e-8, padding="SAME", seed=None, lambd=lamC, name="3.0", activation=None)

    # apply the rely
    conv3 = tf.nn.relu(conv3_res, name='relu_3.0.1')
